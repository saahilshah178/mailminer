# Self-hosting Inbox AI

This is the developer/operator guide for running your own instance of Inbox AI.
...
app/
  ...
  (app)/                  Authenticated app routes
    inbox/                Gmail-style inbox (Primary / Other tabs)
    ask/                  Natural-language Ask AI page
